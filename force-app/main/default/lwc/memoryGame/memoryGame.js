...
import {loadStyle} from 'lightning/platformResourceLoader'      //fomtawesome is css file so to use it import loadStyle
import fontawesome from '@salesforce/resourceUrl/fontawesome'    //Import fontawsemoe static resource where ae sale loadawesome file
export default class MemoryGameLwc extends LightningElement {
    ...
    renderedCallback(){              //It is used To load fontawesome library when page load
        if(this.isLibLoaded){        //to avoid every time load the library use this if else block
            return
        } else {
